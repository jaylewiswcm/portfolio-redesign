 ...
 const Info = () => {
  return (
    <div className="projects-p-container">
      ...
      <p>When designing the site I had to think of 3 different users: promoters, existing fans and people coming across the band for the first time. The band had a great catalogue of photography and videos I wanted to use to interest all 3 users. Straight away as you land on the site you are presented with a high-quality image of the band in action showing who they are, letting the user know they are a live performing 4 piece band. A play bar at the bottom of the screen allows the user to hear them with ease which is great for someone wanting a taste of their sound. There is also a video component to the top right of the page enticing the user to click and watch the band perform live. All in the first few seconds of being introduced to the site the user knows who they are, what they do and get a great example of what they sound like without having to scroll or look through the site for information.</p>
      <p>The site is a single-page website. I made this decision as the band wanted a simple navigation system where the user wouldn’t get lost in pages. The natural flow of the site goes from an introduction, when they are playing and then on to a better understanding of the band through videos, photography and a bio. The site finishes off with a contact component which includes a contact form, social media links and contact details perfect for anyone interested in booking the band for a gig or just wanting to say hello.</p>
      <p>The style of the site has a grunge feel to it which stems from the band’s roots (Alice in Chains, a key member of the Seatle grunge movement).  The font used is ‘Lacquer’ which brings the grunge feel, paired with a white, black and orange colour scheme. Components are positioned and styled on the page to resemble a gig poster, clearly demonstrated through the tour dates and `The Band` components. I wanted the site itself to feel like it was part of the band by taking on the band’s style and influence and I believe I achieved this.</p>
      <h4>Technical</h4>
      ...
      <p>TTo display the videos on the site I had to think of the best method to host and store them because if they were stored locally the site size would be very large and slow down the whole site. To overcome this issue I decided to host the videos on YouTube setting the privacy to private and using the domain as the video src which when selected played using an iframe.</p>
