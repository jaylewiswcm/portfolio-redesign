...
const Bio = () => {
  return ( 
    <div className="bio-container">
      ...
      <p>I like to be somewhat conscious about being fit and healthy so I try to keep my fitness up with walks and occasional runs. I like to be in nature so that’s why I choose walks over running because I like to take in the environment and make the most of it.</p>
      <p>I stopped eating meat in 2020 for a couple of reasons but my health was one of them. I also want to do my part in helping the environment and now I do find eating meat a strange concept but I’m not going to preach it. </p>
      <p>Travelling is another love of mine, I love exploring new places, new cultures, different architecture and tasting new food. I love the freedom travelling brings - being somewhere you’ve never been before, not being able to speak the language, having all your possessions in one backpack but being a place you wouldn’t even dream exists when coming from a town like Chepstow.</p>
      <p>I’ve backpacked Europe a couple of times now, most recently Italy and Turkey which was incredible. Looking back at the memories is amazing and gets me through some days.</p>
      <p>Photography comes hand in hand when travelling and has developed my love for taking photos, organising them and looking back through them. My goal and long-time dream is to get a camper van where I can just set off and go anywhere I want, mainly the coast, near the beach somewhere and stay there feeling like I’m in my own little home.</p>
      <PhotoGallery />
    </div>
  )
}
